...
import predictor.Predictor_TOURNAMENT;

/**
 *
 * @author tatthang
 */
public class BP_TOURNAMENT {
    ...
    private static void doPrediction(){
        ...
        Predictor_TOURNAMENT twoLEVEL_predictor = new Predictor_TOURNAMENT(program, num_of_branches);
